$(document).ready(function () {
    ...
    $("#editProductForm").submit(function (event) {
        ...
        var url = "/api/v1/product/edit/" + id;
        console.log(url);
        $.ajax({
            type: 'post',
            url: url,
            ...
            success: function (data) {
                ...
                createAndShowModal('Thành công', 'Sửa sản phẩm thành công!', true);
            },
            error: function (error) {
                createAndShowModal('Thất bại', 'Sửa sản phẩm thất bại. Vui lòng thử lại', false);
            },
        });
